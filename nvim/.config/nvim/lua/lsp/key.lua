...
local function on_attach(client, bufnr)
  ...
  vim.api.nvim_buf_set_option(bufnr, 'omnifunc', 'v:lua.vim.lsp.omnifunc')
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gd", "<cmd>lua require('diaglist').open_buffer_diagnostics()<cr>", opts)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "gtt", "<cmd>Telescope lsp_references<cr>", opts)
end
